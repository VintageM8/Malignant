...
namespace Malignant.Content
{
    public class FireParticle : Particle
    {
        ...
        {
            Texture2D meow = Request<Texture2D>("Malignant/Assets/Textures/ParticleTextures/Particle2").Value;
            Texture2D weed = Request<Texture2D>("Malignant/Assets/Textures/ParticleTextures/Particle2").Value;
            Texture2D Fmrnch = Request<Texture2D>("Malignant/Assets/Textures/ParticleTextures/Particle2").Value; 
