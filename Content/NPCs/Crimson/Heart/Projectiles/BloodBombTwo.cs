...
{
    public class BloodBombTwo : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Projectile.NewProjectile(null, Projectile.position, new Vector2(-8, 0), ProjectileID.BloodNautilusShot, 20, 2);
                Projectile.NewProjectile(null, Projectile.position, new Vector2(8, 0), ProjectileID.BloodNautilusShot, 20, 2);
                Projectile.NewProjectile(null, Projectile.position, new Vector2(-5, 5), ProjectileID.BloodNautilusShot, 20, 2);
                Projectile.NewProjectile(null, Projectile.position, new Vector2(5, 5), ProjectileID.BloodNautilusShot, 20, 2);
                Projectile.NewProjectile(null, Projectile.position, new Vector2(-5, -5), ProjectileID.BloodNautilusShot, 20, 2);
                Projectile.NewProjectile(null, Projectile.position, new Vector2(5, -5), ProjectileID.BloodNautilusShot, 20, 2);
                Projectile.NewProjectile(null, Projectile.position, new Vector2(0, 8), ProjectileID.BloodNautilusShot, 20, 2);
                Projectile.NewProjectile(null, Projectile.position, new Vector2(0, -8), ProjectileID.BloodNautilusShot, 20, 2);
                Projectile.Kill();
            }
        }
