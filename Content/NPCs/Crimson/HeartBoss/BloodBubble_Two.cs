...
{
    public class BloodBubble_Two : ModProjectile
    {
        Vector2 stored;
        Vector2 storedpos;
        ...
        private void DrawLine(Vector2 start, Vector2 end, Color color, float scale = 1)
        {
            ...
            for (int i = 0; i < length; i++)
            {
                ...
                Main.EntitySpriteDraw(ModContent.Request<Texture2D>("Malignant/Assets/Textures/Pixel").Value, drawpos, null, color, 0, Vector2.Zero, scale, SpriteEffects.None, 0);
            }
        }
