...
{
    public class SpikeSpawner : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(null, new Vector2(Projectile.Center.X, Projectile.Center.Y + 8), new Vector2(0f, 0f), ModContent.ProjectileType<SpikeSpawner_2>(), 25, 10);
        }
        ...
        public override void AI()
        {
            ...
            if (collidedPlatform == false)
            {
                ...
                {
                    Projectile.NewProjectile(null, new Vector2(Projectile.Center.X, Projectile.Center.Y + 2), new Vector2(0f, 0f), ModContent.ProjectileType<SpikeSpawner_2>(), 25, 10);
    ...
    public class SpikeSpawner_2 : ModProjectile
    {
        public override string Texture => "Malignant/Assets/Textures/Pixel";
        public override void SetDefaults()
        {
