...
{
    public class Rune_1 : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            if (Projectile.timeLeft < 260)
            {
                ...
                Texture2D texture2D = ModContent.Request<Texture2D>("Malignant/Effects/Circles", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
                if (Projectile.velocity.X == 0)
                {
                    addHeight = -8f;
                    addWidth = -6f;
                    texture2D = ModContent.Request<Texture2D>("Malignant/Effects/Circles", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value;
                }
