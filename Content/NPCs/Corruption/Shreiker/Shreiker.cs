    ...
    public class Shreiker : ModNPC
    {
        ...
        public override void SetBestiary(BestiaryDatabase database, BestiaryEntry bestiaryEntry)
        {
            bestiaryEntry.Info.AddRange(new IBestiaryInfoElement[] {
                ...
                new FlavorTextBestiaryInfoElement("Once a prestine member of the churh, these corrupted preists have denouced our Lord and vowed their loyalty to Lucifer."),
            });
        }

        public override float SpawnChance(NPCSpawnInfo spawnInfo) => spawnInfo.Player.ZoneCorrupt && Main.hardMode && !NPC.AnyNPCs(ModContent.NPCType<Shreiker>()) ? 0.013f : 0f;
        ...
        public override void AI()
        {
            ...
            if (NPC.ai[0] >= 680)
            {
                ...
                MethodHelper.DrawStar(NPC.Center, DustID.GoldCoin, pointAmount: 5, mainSize: 2.25f * 2.33f, dustDensity: 2, pointDepthMult: 0.3f, noGravity: true);
