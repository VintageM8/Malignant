...
{
    public class CarnemProj_Two : ModProjectile
    {
        ...
        public override bool PreDraw(ref Color lightColor)
        {
            ...
            Color color = MalignantPlayer.Crimson;
            color.A = 0;
            for (int k = 0; k < 4; k++)
            {
        ...
        public override void AI()
        {
            ...
            Dust dust2 = Dust.NewDustDirect(Projectile.Center - new Vector2(4, 4), 0, 0, ModContent.DustType<Blood>(), 0, 0, 100);
            dust2.velocity *= 0;
            dust2.velocity -= Projectile.velocity * 0.1f;
            dust2.noGravity = true;
            dust2.color = MalignantPlayer.Crimson;
            dust2.noGravity = true;
            dust2.fadeIn = 0.2f;
            dust2.scale = 1.8f;
        }
