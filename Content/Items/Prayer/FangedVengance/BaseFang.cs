...
{
    public class BaseFang : ModProjectile
    {
        ...
        {
            Projectile.NewProjectile(null, Projectile.position, new Vector2(-8, 0), ModContent.ProjectileType<HomingFang>(), 20, 2);
            Projectile.NewProjectile(null, Projectile.position, new Vector2(8, 0), ModContent.ProjectileType<HomingFang>(), 20, 2);
            Projectile.NewProjectile(null, Projectile.position, new Vector2(5, -5), ModContent.ProjectileType<HomingFang>(), 20, 2);
