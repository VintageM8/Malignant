...
{
    public class NjorHoldout : ModProjectile
    {
                ...
                else
                {
                    ...
                    if (player.GetModPlayer<MalignantPlayer>().BuildCount == 6)
                    {
                        ...
                        if (Projectile.ai[1] % 5 == 0)
                        {
                            ...
                            Projectile.NewProjectile(Projectile.GetSource_FromAI(), Projectile.Center, ProjectileVelocity * 4, ModContent.ProjectileType<NjorsStaffproj>(), Projectile.damage, Projectile.knockBack, Projectile.owner);
                        }
                    }
                    else
                    {
