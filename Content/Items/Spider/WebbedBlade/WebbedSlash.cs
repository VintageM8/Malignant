...
namespace Malignant.Content.Items.Spider.WebbedBlade
{
    public class WebbedSlash : ModProjectile
    {
        ...
        public void DrawProj_Excalibur(Projectile proj)
        {
            ...
            Asset<Texture2D> val = ModContent.Request<Texture2D>("Malignant/Content/Items/Spider/WebbedBlade/WebbedSlash");
    ...
    {
        public override string Texture => "Malignant/Content/Items/Spider/WebbedBlade/WebbedSlash";
