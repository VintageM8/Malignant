...
namespace Malignant.Content.Items.Weapon.Njor.NjorSword
{
    public class NjorSwordProj4 : ModProjectile
    {
        ...
        public override string Texture => "Malignant/Content/Items/Weapon/Njor/NjorSword/IceSword";
        ...
        public override void AI()
        {
            ...
            if (!ParticleSpawned)
            {
                Dust dust = Dust.NewDustDirect(Projectile.position - Projectile.velocity, Projectile.width, Projectile.height, DustID.Ice, 0, 0, 100, Color.Blue, 1f);
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                dust.noGravity = true;
                dust.velocity *= 2f;
                dust = Dust.NewDustDirect(Projectile.position - Projectile.velocity, Projectile.width, Projectile.height, DustID.Snow, 0f, 0f, 1000, Color.Blue, 1f);
            }
            AttachToPlayer();
