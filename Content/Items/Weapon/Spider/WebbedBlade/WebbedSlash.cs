...
{
    public class WebbedSlash : ModProjectile
    {
        ...
        public override void AI()
        {
            ...
            {
                Dust dust2 = Dust.NewDustPerfect(Projectile.Center + num8.ToRotationVector2() * (Main.rand.NextFloat() * 80f * Projectile.scale + 20f * Projectile.scale), 278, vector3 * 1f, DustID.WhiteTorch, Color.Lerp(Color.Gold, Color.Purple, Main.rand.NextFloat() * 1f), 0.4f);
                dust2.fadeIn = 0.4f + Main.rand.NextFloat() * 0.15f;
                dust2.noGravity = true;
            }
            //if (Main.rand.NextFloat() * 1.5f < Projectile.Opacity)
            {
                Dust.NewDustPerfect(vector2, DustID.WhiteTorch, vector3 * 1f, 100, Color.White * Projectile.Opacity, 1.2f * Projectile.Opacity);
            }
        ...
        {
            Texture2D value = Main.Assets.Request<Texture2D>("Assets/Projectile_658").Value;
        ...
        public void DrawProj_Excalibur(Projectile proj)
        {
            ...
            Asset<Texture2D> val = ModContent.Request<Texture2D>("Malignant/Content/Items/Weapon/Spider/WebbedBlade/WebbedSlash");
            ...
            Main.spriteBatch.Draw(val.Value, vector, rectangle, new Color(248, 248, 255) * fromValue * num3, proj.rotation + proj.ai[0] * ((float)Math.PI / 4f) * -1f * (1f - num2), origin, num, effects, 0f);
            ...
            Main.spriteBatch.Draw(val.Value, vector, rectangle, new Color(248, 248, 255) * 0.4f, proj.rotation, origin, num * 0.8f, effects, 0f);
            Main.spriteBatch.Draw(val.Value, vector, rectangle, new Color(245, 245, 245) * 0.4f, proj.rotation, origin, num * num4 * 0.6f, effects, 0f);
            ...
            for (float num5 = 0f; num5 < 8f; num5++)
            {
                ...
                float num7 = num5 / 9f;
                DrawPrettyStarSparkle(proj.Opacity, SpriteEffects.None, drawpos, new Color(255, 255, 255, 0) * num3 * num7, new Color(248, 248, 255), new Color(25, 25, 25, 0), new Color(167, 118, 65, 0), num2, 0f, 0.5f, 0.5f, 1f, num6, new Vector2(0f, Utils.Remap(num2, 0f, 1f, 3f, 0f)) * num, Vector2.One * num);
            }
            ...
            DrawPrettyStarSparkle(proj.Opacity, SpriteEffects.None, drawpos2, new Color(255, 255, 255, 0) * num3 * 0.5f, new Color(245, 245, 245), new Color(167, 118, 65, 0), new Color(167, 118, 65, 0), num2, 0f, 0.5f, 0.5f, 1f, 0f, new Vector2(2f, Utils.Remap(num2, 0f, 1f, 4f, 1f)) * num, Vector2.One * num);
        }
    ...
    public class WebbedSlash2 : ModProjectile
    {
        public override string Texture => "Malignant/Content/Items/Weapon/Spider/WebbedBlade/WebbedSlash";
        ...
        public void DrawProj_Excalibur(Projectile proj)
        {
            ...
            for (float num5 = 0f; num5 < 8f; num5++)
            {
                ...
                float num7 = num5 / 9f;
                DrawPrettyStarSparkle(proj.Opacity, SpriteEffects.None, drawpos, new Color(255, 255, 255, 0) * num3 * num7, new Color(245, 245, 245), new Color(25, 25, 25, 0), new Color(248, 248, 255, 0), num2, 0f, 0.5f, 0.5f, 1f, num6, new Vector2(0f, Utils.Remap(num2, 0f, 1f, 3f, 0f)) * num, Vector2.One * num);
            }
