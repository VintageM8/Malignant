...
namespace Malignant.Content.Dusts
{
    public class Glow : ModDust
    {
        ...
        public override void OnSpawn(Dust dust)
        {
            ...
            dust.shader = new Terraria.Graphics.Shaders.ArmorShaderData(new Ref<Effect>(Malignant.Instance.Assets.Request<Effect>("Effects/GlowingDust", ReLogic.Content.AssetRequestMode.ImmediateLoad).Value), "GlowingDustPass");
        }
