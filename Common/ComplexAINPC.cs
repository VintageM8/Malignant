...
{
    internal record StateTime(float Frames)
    {
        public float Seconds => Frames / 60f;
    }

    internal abstract class ComplexAINPC<TState> : ModNPC where TState : Enum
    {
        ...
        protected StateTime StateTime { get; private set; }
